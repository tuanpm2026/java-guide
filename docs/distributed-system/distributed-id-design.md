...
![Ví dụ payment thư viện tài liệu](/images/github/javaguide/system-design/distributed-system/distributed-id-design-pay-one-card.png)
...
![Đổi quà bằng mã ưu đãi](/images/github/javaguide/system-design/distributed-system/distributed-id-design-coupon.png)
...
![Distributed Tracing](/images/github/javaguide/system-design/distributed-system/distributed-id-design-tracing.png)
...
![Tác dụng của Short URL](/images/github/javaguide/system-design/distributed-system/distributed-id-design-short-url.png)
