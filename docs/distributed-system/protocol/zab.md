...
![Cấu trúc ZXID](/images/github/javaguide/distributed-system/protocol/zab-zxid-structure.png)
...
![ZAB Message Broadcast Mode](/images/github/javaguide/distributed-system/protocol/zab-message-broadcast-flow.png)
...
![zab-crash-recovery-flow](/images/github/javaguide/distributed-system/protocol/zab-crash-recovery-flow.png)
