...
![Consensus algorithm architecture](https://oss.javaguide.cn/github/javaguide/paxos-rsm-architecture.png)
...
![Raft server state transition diagram](https://oss.javaguide.cn/github/javaguide/paxos-server-state.png)

### 2.2 Terms (Nhiệm kỳ)

![Term diagram](https://oss.javaguide.cn/github/javaguide/paxos-term.png)
...
![Raft Term Progression](https://oss.javaguide.cn/github/javaguide/distributed-system/protocol/raft-term-progression.png)
...
![Raft Leader Election Flow](https://oss.javaguide.cn/github/javaguide/distributed-system/protocol/raft-election.png)
