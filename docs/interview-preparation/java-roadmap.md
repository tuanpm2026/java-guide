...
![Java Learning Path PDF Overview - Light Mode](/images/github/javaguide/interview-preparation/java-road-map-pdf.png)

Tổng quan dark mode:

![Java Learning Path PDF Overview - Dark Mode](/images/github/javaguide/interview-preparation/java-road-map-pdf-dark.png)
...
![Java Learning Roadmap](/images/github/javaguide/interview-preparation/java-road-map.png)
...
![JavaGuide Official WeChat Account](/images/github/javaguide/gongzhonghaoxuanchuan.png)
