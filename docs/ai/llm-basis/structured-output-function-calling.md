...
![Ba tầng ràng buộc giai đoạn sinh: JSON Mode quản lý cú pháp, JSON Schema quản lý hợp đồng, Structured Outputs đưa hợp đồng về trước giai đoạn sinh mô hình](/images/github/javaguide/ai/llm/structured-output-function-calling-three-layer-constraint.png)
...
![Pipeline gọi đầy đủ Function Calling: mô hình chỉ tạo ý định gọi, thực sự thực thi công cụ là phía nghiệp vụ](/images/github/javaguide/ai/llm/structured-output-function-calling-function-calling-pipeline.png)
...
![Phân tầng rủi ro bảo mật gọi công cụ: ánh xạ chiến lược kiểm soát khác nhau theo mức độ rủi ro](/images/github/javaguide/ai/llm/structured-output-function-calling-tool-call-security.png)
