...
![Tại sao tình huống RAG cần cơ sở dữ liệu vector?](/images/github/javaguide/ai/rag/rag-why-need-vector-store.png)
...
![Phân loại thuật toán chỉ mục vector](/images/github/javaguide/ai/rag/rag-vector-index-algorithms.png)
...
![Kiến trúc chỉ mục HNSW](/images/github/javaguide/ai/rag/rag-hnsw-architecture.png)
...
![Cột VECTOR không thể được dùng như bất kỳ loại khóa nào, bao gồm primary key, foreign key, unique key và partition key](/images/github/javaguide/ai/rag/mysql9-vector-cannot-be-used-as-any-type-of-key.png)
...
![Tổng quan nội dung hướng dẫn](/images/xingqiu/pratical-project/interview-guide/tutorial-overview.png)
