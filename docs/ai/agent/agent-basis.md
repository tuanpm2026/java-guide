...
![Quy trình hoạt động Agent Loop](https://oss.javaguide.cn/github/javaguide/ai/agent/agent-loop-flow.png)
...
![Quy trình mô hình ReAct](https://oss.javaguide.cn/github/javaguide/ai/agent/agent-react-flow.png)
...
![Kiến trúc hệ thống Multi-Agent (Mô hình Orchestrator-Subagent)](https://oss.javaguide.cn/github/javaguide/ai/agent/agent-multi-agent-arch.png)
...
![Kiến trúc giao thức giao tiếp A2A (Agent-to-Agent)](https://oss.javaguide.cn/github/javaguide/ai/agent/agent-a2a.png)
...
![Mô hình cốt lõi của Agentic Workflows (Luồng làm việc tác nhân thông minh)](https://oss.javaguide.cn/github/javaguide/ai/agent/agent-agentic-workflows.png)
