...
![So sánh Workflow truyền thống và AI Workflow](/images/github/javaguide/ai/workflow/traditional-vs-ai-workflow.svg)
...
![Tổng quan Loop: Sơ đồ cơ chế vòng lặp](/images/github/javaguide/ai/workflow/loop-mechanism.svg)
...
![Tổng quan mối quan hệ Workflow, Graph, Loop](/images/github/javaguide/ai/workflow/workflow-graph-loop-relation.svg)
...
![So sánh workflow trừu tượng cao và thấp](/images/github/javaguide/ai/workflow/abstraction-comparison.svg)
...
![Yếu tố cốt lõi của Graph: Node, Edge, State](/images/github/javaguide/ai/workflow/graph-core-elements.svg)
