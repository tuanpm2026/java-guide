...
![Khung bốn yếu tố của Prompt](/images/github/javaguide/ai/context-engineering/prompt-four-element-framework.svg)
...
![Sáu kỹ thuật cốt lõi](/images/github/javaguide/ai/context-engineering/prompt-six-core-techniques.svg)
...
![Ba dạng của CoT](/images/github/javaguide/ai/context-engineering/cot-three-forms.svg)
...
![Luồng thực thi CoT có cấu trúc](/images/github/javaguide/ai/context-engineering/structured-cot-execution-flow.svg)
...
![Học ít mẫu](/images/github/javaguide/ai/context-engineering/few-shot-learning.svg)
...
![Phân rã nhiệm vụ](/images/github/javaguide/ai/context-engineering/task-decomposition.svg)
...
![So sánh các định dạng đầu ra có cấu trúc](/images/github/javaguide/ai/context-engineering/structured-output-formats.svg)
...
![Hệ thống phòng thủ ba lớp chống Prompt Injection](/images/github/javaguide/ai/context-engineering/prompt-injection-protection-three-layer-defense-in-depth-system.svg)
