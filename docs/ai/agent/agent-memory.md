...
![Sơ đồ toàn cảnh phân loại bộ nhớ Agent](/images/github/javaguide/ai/agent/agent-memory-memory-taxonomy.svg)
...
![Kiến trúc hệ thống bộ nhớ AI Agent](/images/github/javaguide/ai/agent/agent-memory-arch.png)
...
![Vòng đời thao tác bộ nhớ](/images/github/javaguide/ai/agent/agent-memory-lifestyle.png)
...
![Hiện tượng ngưỡng 40% tỷ lệ sử dụng ngữ cảnh](/images/github/javaguide/ai/harness/context-utilization-40-percent-threshold-phenomenon.svg)
...
![Sự khác biệt giữa bộ nhớ dài hạn và RAG (Retrieval-Augmented Generation)](/images/github/javaguide/ai/agent/agent-memory-rag-vs-memory.svg)
...
![Cơ chế tiến hóa nâng cao của hệ thống bộ nhớ](/images/github/javaguide/ai/agent/agent-memory-evolution.png)
...
![Chiến lược tối ưu hóa truy vấn bộ nhớ dài hạn](/images/github/javaguide/ai/agent/agent-memory-retrieval-optimization.png)
...
![Ranh giới áp dụng của bộ nhớ Markdown và bộ nhớ dài hạn truyền thống](/images/github/javaguide/ai/agent/agent-memory-markdown-memory-boundary.svg)
