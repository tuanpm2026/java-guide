...
![Phân tích Key Alibaba Cloud](https://oss.javaguide.cn/github/javaguide/database/redis/aliyun-key-analysis.png)
...
![hotkey mã nguồn mở của JD Retail](https://oss.javaguide.cn/github/javaguide/database/redis/jd-hotkey.png)
...
![Tối ưu vấn đề Key nóng thông qua Proxy Query Cache của Alibaba Cloud](https://oss.javaguide.cn/github/javaguide/database/redis/aliyun-hotkey-proxy-query-cache.png)
...
![Sơ đồ flow xử lý cache sau khi thêm Bloom filter](https://oss.javaguide.cn/github/javaguide/database/redis/redis-cache-penetration-bloom-filter.png)
