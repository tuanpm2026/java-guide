...
![Tổng quan kiểu dữ liệu Redis](https://oss.javaguide.cn/github/javaguide/database/redis/redis-overview-of-data-types-2023-09-28.jpg)
...
![Redis expiration dictionary](https://oss.javaguide.cn/github/javaguide/database/redis/redis-expired-dictionary.png)
...
![redis.conf chú thích về hz](https://oss.javaguide.cn/github/javaguide/database/redis/redis.conf-hz.png)
