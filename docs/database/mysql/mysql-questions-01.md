...
![Mối quan hệ bảng trong cơ sở dữ liệu quan hệ](/images/java-guide-blog/5e3c1a71724a38245aa43b02_99bf70d46cc247be878de9d3a88f0c44.png)
...
![](/images/github/javaguide/csdn/20210327143351823.png)
...
![Tổng hợp các kiểu trường MySQL thường gặp](/images/github/javaguide/mysql/summary-of-mysql-field-types.png)
...
![Xem tất cả storage engine MySQL cung cấp](/images/github/javaguide/mysql/image-20220510105408703.png)
...
![](/images/github/javaguide/mysql/image-20220510155143458.png)
...
![MySQL architecture diagram showing connectors, interfaces, pluggable storage engines, the file system with files and logs.](/images/github/javaguide/mysql/mysql-architecture.png)
...
![](/images/github/javaguide/mysql/image-20220510090309427.png)
...
![So sánh hiệu suất InnoDB và MyISAM](/images/github/javaguide/mysql/innodb-myisam-performance-comparison.png)
...
![So sánh một số storage engine MySQL phổ biến](/images/github/javaguide/mysql/comparison-of-common-mysql-storage-engines.png)
...
![](/images/github/javaguide/database/mysql/leftmost-prefix-matching-rule.png)
...
![MySQL 8.0: Retiring Support for the Query Cache](/images/github/javaguide/mysql/mysql8.0-retiring-support-for-the-query-cache.png)
...
![《Hướng dẫn phỏng vấn Java》- Phần câu hỏi phỏng vấn kỹ thuật](/images/javamianshizhibei/technical-interview-questions.png)
...
![事务示意图](/images/github/javaguide/mysql/%E4%BA%8B%E5%8A%A1%E7%A4%BA%E6%84%8F%E5%9B%BE.png)
...
![数据库事务示意图](/images/github/javaguide/mysql/%E6%95%B0%E6%8D%AE%E5%BA%93%E4%BA%8B%E5%8A%A1%E7%A4%BA%E6%84%8F%E5%9B%BE.png)

Ngoài ra, transaction của các cơ sở dữ liệu quan hệ (ví dụ: `MySQL`, `SQL Server`, `Oracle`, v.v.) đều có đặc tính **ACID**:

![ACID](/images/github/javaguide/mysql/ACID.png)
...
![AID->C](/images/github/javaguide/mysql/AID-%3EC.png)
...
![](/images/github/javaguide/books/ddia.png)
...
![脏读](/images/github/javaguide/database/mysql/concurrency-consistency-issues-dirty-reading.png)
...
![丢失修改](/images/github/javaguide/database/mysql/concurrency-consistency-issues-missing-modifications.png)
...
![不可重复读](/images/github/javaguide/database/mysql/concurrency-consistency-issues-unrepeatable-read.png)
...
![幻读](/images/github/javaguide/database/mysql/concurrency-consistency-issues-phantom-read.png)
...
![](/images/github/javaguide/mysql/image-20220511171419081.png)
...
![](/images/github/javaguide/mysql/oss-search.png)
...
![Các phương pháp tối ưu SQL phổ biến](/images/javamianshizhibei/javamianshizhibei-sql-optimization.png)
