...
![MongoDB Document](/images/github/javaguide/database/mongodb/crud-annotated-document..png)
...
![Trang chủ website BSON](/images/github/javaguide/database/mongodb/bsonspec.org.png)
...
![MongoDB Collection](/images/github/javaguide/database/mongodb/crud-annotated-collection.png)
...
![Cấu trúc tổng thể B+ tree của WiredTiger](/images/github/javaguide/database/mongodb/mongodb-b-plus-tree-integral-structure.png)
...
![Quy trình làm việc của pipeline](/images/github/javaguide/database/mongodb/mongodb-aggregation-stage.png)
