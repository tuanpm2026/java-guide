...
![Hiệu ứng demo Trie tree trình duyệt](/images/github/javaguide/system-design/security/brower-trie.png)
...
![Trie tree từ nhạy cảm](/images/github/javaguide/system-design/security/sensitive-word-trie.png)
...
![Luồng xây dựng và khớp AC automaton](/images/github/javaguide/system-design/security/sensitive-word-ac-automaton-flow.png)
...
![Thuật toán DFA của Hutool](/images/github/javaguide/system-design/security/hutool-dfa.png)
...
![](/images/github/javaguide/system-design/security/sensitive-word-filter-arch.png)
