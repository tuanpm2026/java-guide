...
![Tham chiếu vòng giữa các đối tượng](https://oss.javaguide.cn/github/javaguide/java/jvm/object-circular-reference.png)
...
![Thuật toán phân tích khả năng tiếp cận](https://oss.javaguide.cn/github/javaguide/java/jvm/jvm-gc-roots.png)
...
![Tóm tắt các loại tham chiếu Java](https://oss.javaguide.cn/github/javaguide/java/jvm/java-reference-type.png)
...
![Thuật toán đánh dấu-xóa](https://oss.javaguide.cn/github/javaguide/java/jvm/mark-and-sweep-garbage-collection-algorithm.png)
...
![Thuật toán sao chép](https://oss.javaguide.cn/github/javaguide/java/jvm/copying-garbage-collection-algorithm.png)
...
![Thuật toán đánh dấu-nén](https://oss.javaguide.cn/github/javaguide/java/jvm/mark-and-compact-garbage-collection-algorithm.png)
...
![Bộ thu gom Serial](https://oss.javaguide.cn/github/javaguide/java/jvm/serial-garbage-collector.png)
...
![Bộ thu gom ParNew](https://oss.javaguide.cn/github/javaguide/java/jvm/parnew-garbage-collector.png)
...
![Sơ đồ hoạt động của bộ thu gom Parallel Old](https://oss.javaguide.cn/github/javaguide/java/jvm/parallel-scavenge-garbage-collector.png)
...
![Bộ thu gom CMS](https://oss.javaguide.cn/github/javaguide/java/jvm/cms-garbage-collector.png)
...
![Bộ thu gom G1](https://oss.javaguide.cn/github/javaguide/java/jvm/g1-garbage-collector.png)
