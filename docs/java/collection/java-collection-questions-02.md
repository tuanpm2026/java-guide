...
![Sơ đồ kế thừa TreeMap](/images/github/javaguide/java/collection/treemap_hierarchy.png)
...
![Cấu trúc nội bộ sau jdk1.8-HashMap](/images/github/javaguide/java/collection/jdk1.8_hashmap.png)
...
![Cấu trúc nội bộ Hashtable](/images/github/javaguide/java/collection/jdk1.7_hashmap.png)
