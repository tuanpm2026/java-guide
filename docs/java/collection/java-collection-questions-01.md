...
![Tổng quan framework Java Collection](/images/github/javaguide/java/collection/java-collection-hierarchy.png)
...
![Logic phương thức unlink](/images/github/javaguide/java/collection/linkedlist-unlink.jpg)
...
![](/images/github/javaguide/redisimage-20220412110853807.png)
...
![Danh sách liên kết đôi](/images/github/javaguide/cs-basics/data-structure/bidirectional-linkedlist.png)
...
![Danh sách liên kết đôi vòng](/images/github/javaguide/cs-basics/data-structure/bidirectional-circular-linkedlist.png)
...
![](/images/github/javaguide/java/collection/fail-fast-and-fail-safe-copyonwritearraylist.png)
...
![BlockingQueue](/images/github/javaguide/java/collection/blocking-queue.png)

### Có những lớp cài đặt nào của BlockingQueue?

![Các lớp cài đặt của BlockingQueue](/images/github/javaguide/java/collection/blocking-queue-hierarchy.png)
