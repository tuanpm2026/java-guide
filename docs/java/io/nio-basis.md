...
![BIO、NIO 和 AIO 对比](/images/github/javaguide/java/nio/bio-aio-nio.png)
...
![Buffer、Channel和Selector三者之间的关系](/images/github/javaguide/java/nio/channel-buffer-selector.png)
...
![Buffer 的子类](/images/github/javaguide/java/nio/buffer-subclasses.png)
...
![position 、limit 和 capacity 之前的关系](/images/github/javaguide/java/nio/JavaNIOBuffer.png)

![position 、limit 和 capacity 之前的关系](/images/github/javaguide/java/nio/NIOBufferClassAttributes.png)
...
![capacity、limit和position每一阶段的变化](/images/github/javaguide/java/nio/NIOBufferClassAttributesDataChanges.png)
...
![Channel 和 Buffer之间的关系](/images/github/javaguide/java/nio/channel-buffer.png)
...
![Channel 的子类](/images/github/javaguide/java/nio/channel-subclasses.png)
...
![Channel继承关系图](/images/github/javaguide/java/nio/channel-inheritance-relationship.png)
...
![Selector 选择器工作示意图](/images/github/javaguide/java/nio/selector-channel-selectionkey.png)
