...
![](/images/github/javaguide/java/basis/JavaSeSpecifications.jpg)
...
![jdk-include-jre](/images/github/javaguide/java/basis/jdk-include-jre.png)
...
![Quá trình chuyển đổi chương trình Java thành machine code](/images/github/javaguide/java/basis/java-code-to-machine-code.png)
...
![Quá trình chuyển đổi chương trình Java thành machine code (có JIT)](/images/github/javaguide/java/basis/java-code-to-machine-code-with-jit.png)
...
![Mối quan hệ giữa JDK, JRE, JVM, JIT](/images/github/javaguide/java/basis/jdk-jre-jvm-jit.png)

Hình dưới là mô hình cấu trúc tổng quát của JVM.

![Mô hình cấu trúc tổng quát của JVM](/images/github/javaguide/java/basis/jvm-rough-structure-model.png)
...
![Ngôn ngữ biên dịch và ngôn ngữ thông dịch](/images/github/javaguide/java/basis/compiled-and-interpreted-languages.png)
...
<img src="/images/github/javaguide/java/basis/jit-vs-aot.png" alt="JIT vs AOT" style="zoom: 25%;" />
...
![oracle jdk release cadence](/images/github/javaguide/java/basis/oracle-jdk-release-cadence.jpg)
...
![](/images/github/javaguide/java/basis/image-20220714112336911.png)
...
![](/images/github/javaguide/up-1ae0425ce8646adfb768b5374951eeb820d.png)
...
![](/images/github/javaguide/java/basis/java-basis-variables-member-variable-vs-local-variable.png)
...
![](/images/github/javaguide/java/basis/java-basis-variables-static-variable.png)
