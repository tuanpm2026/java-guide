...
![Cache coherence protocol](/images/github/javaguide/java/concurrent/cpu-cache-protocol.png)
...
![Ý tưởng thiết kế JMM](/images/github/javaguide/java/concurrent/jmm-design-idea.png)
...
![jmm-vs-happens-before](/images/github/javaguide/java/concurrent/jmm-vs-happens-before.png)
