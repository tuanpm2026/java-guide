...
![](/images/github/javaguide/AQS.png)
...
![Cấu trúc hàng đợi CLH lock](/images/github/javaguide/open-source-project/clh-lock-queue-structure.png)
...
![Cấu trúc CLH variant queue](/images/github/javaguide/java/concurrent/clh-queue-structure-bianti.png)
...
![CLH variant queue](/images/github/javaguide/java/concurrent/clh-queue-state.png)
...
![AQS exclusive mode acquire lock](/images/github/javaguide/java/concurrent/aqs-exclusive-mode-acquire-lock.png)
...
![](/images/github/javaguide/java/concurrent/clh-queue-structure-init.png)
...
![](/images/github/javaguide/java/concurrent/aqs-addWaiter.png)
...
![](/images/github/javaguide/java/concurrent/aqs-acquire-and-release-process.png)
...
![](/images/github/javaguide/java/concurrent/aqs-acquire-and-release-process-2.png)
...
![](/images/github/javaguide/java/concurrent/aqs-acquire-and-release-process-3.png)
...
![](/images/github/javaguide/java/concurrent/aqs-acquire-and-release-process-4.png)
...
![](/images/github/javaguide/java/concurrent/aqs-acquire-and-release-process-5.png)
