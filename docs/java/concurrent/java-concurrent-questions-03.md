...
![Cấu trúc dữ liệu ThreadLocal](/images/github/javaguide/java/concurrent/threadlocal-data-structure.png)

`ThreadLocalMap` là lớp inner static của `ThreadLocal`.

![Lớp nội tại ThreadLocal](/images/github/javaguide/java/concurrent/thread-local-inner-class.png)
...
![Biểu đồ tuần tự toàn bộ quá trình CRR do TTL cung cấp chính thức](/images/github/javaguide/java/concurrent/ttl-crr-timing-diagram.png)
...
![Mối quan hệ giữa các tham số của thread pool](/images/github/javaguide/java/concurrent/relationship-between-thread-pool-parameters.png)
...
![Điều chỉnh kích thước blocking queue và max thread count](/images/github/javaguide/java/concurrent/threadpool-reject-2-threadpool-reject-01.png)
...
![Lưu một phần task vào MySQL](/images/github/javaguide/java/concurrent/threadpool-reject-2-threadpool-reject-02.png)
...
![Hiệu quả cuối cùng của việc cấu hình động tham số thread pool](/images/github/javaguide/java/concurrent/meituan-dynamically-configuring-thread-pool-parameters.png)
...
![《Câu hỏi System Design & tình huống thường gặp trong phỏng vấn Backend》](/images/xingqiu/back-end-interview-high-frequency-system-design-and-scenario-questions-fengmian.png)
...
![Constructor ThreadPoolExecutor](/images/github/javaguide/java/concurrent/common-parameters-of-threadpool-workqueue.jpg)
...
![Cấu trúc hàng đợi của CLH lock](/images/github/javaguide/open-source-project/clh-lock-queue-structure.png)
...
![Cấu trúc hàng đợi biến thể CLH](/images/github/javaguide/java/concurrent/clh-queue-structure-bianti.png)

Sơ đồ nguyên lý cốt lõi của AQS (`AbstractQueuedSynchronizer`):

![Hàng đợi biến thể CLH](/images/github/javaguide/java/concurrent/clh-queue-state.png)
