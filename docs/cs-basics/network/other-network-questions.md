...
![OSI 七层模型](/images/github/javaguide/cs-basics/network/osi-7-model.png)
...
![osi七层模型2](/images/github/javaguide/osi七层模型2.png)
...
![TCP/IP 四层模型](/images/github/javaguide/cs-basics/network/tcp-ip-4-model.png)
...
![应用层常见协议](/images/github/javaguide/cs-basics/network/application-layer-protocol.png)
...
![传输层常见协议](/images/github/javaguide/cs-basics/network/transport-layer-protocol.png)
...
<img src="/images/github/javaguide/url%E8%BE%93%E5%85%A5%E5%88%B0%E5%B1%95%E7%A4%BA%E5%87%BA%E6%9D%A5%E7%9A%84%E8%BF%87%E7%A8%8B.jpg" style="zoom:50%" />
...
![常见 HTTP 状态码](/images/github/javaguide/cs-basics/network/http-status-code.png)
...
![HTTP 和 HTTPS 对比](/images/github/javaguide/cs-basics/network/http-vs-https.png)
...
![HTTP/1.0 和 HTTP/1.1 对比](/images/github/javaguide/cs-basics/network/http1.0-vs-http1.1.png)
...
![HTTP/1.0 和 HTTP/1.1 对比](/images/github/javaguide/cs-basics/network/http1.1-vs-http2.0.png)
...
![HTTP/2 Multiplexing](/images/github/javaguide/cs-basics/network/http2.0-multiplexing.png)
...
![HTTP/2.0 和 HTTP/3.0 对比](/images/github/javaguide/cs-basics/network/http2.0-vs-http3.0.png)
...
![HTTP/2.0 和 HTTP/3.0 详细对比图](/images/github/javaguide/cs-basics/network/http2-and-http3-stacks-comparison.png)
...
![JWT 身份验证示意图](/images/github/javaguide/system-design/jwt/jwt-authentication%20process.png)
...
![Websocket 示意图](/images/github/javaguide/system-design/web-real-time-message-push/1460000042192394.png)
...
![DeepSeek 响应标头](/images/github/javaguide/cs-basics/network/deepseek-sse.png)

![](/images/github/javaguide/cs-basics/network/deepseek-sse-eventstream.png)
...
![DNS:域名系统](/images/github/javaguide/cs-basics/network/dns-overview.png)
