...
![Message boundary của TCP và UDP](/images/github/javaguide/cs-basics/network/tcp-udp-byte-stream-tcp-udp-message-boundary.png)
...
![Tại sao sticky packet / split packet của TCP xuất hiện?](/images/github/javaguide/cs-basics/network/tcp-udp-byte-stream-tcp-sticky-split-causes.png)
...
![Tầng ứng dụng nên định nghĩa message boundary như thế nào?](/images/github/javaguide/cs-basics/network/tcp-udp-byte-stream-tcp-message-boundary-solutions.png)
...
![Tại sao Nagle + Delayed ACK có thể làm chậm gói nhỏ?](/images/github/javaguide/cs-basics/network/tcp-udp-byte-stream-nagle-delayed-ack-latency.png)
