...
![](/images/2020-8/image-20200807161118901.png)
...
![Kernel_Layout](/images/2020-8/Kernel_Layout.png)
...
![Chế độ người dùng và chế độ nhân](/images/github/javaguide/cs-basics/operating-system/usermode-and-kernelmode.png)
...
![3 cách chuyển từ user mode sang kernel mode](/images/github/javaguide/cs-basics/operating-system/the-way-switch-between-user-mode-and-kernel-mode.drawio.png)
...
![System call](/images/github/javaguide/cs-basics/operating-system/system-call.png)
...
![Quá trình system call](/images/github/javaguide/cs-basics/operating-system/system-call-procedure.png)
...
![](/images/github/javaguide/cs-basics/operating-system/process-and-thread-difference-wechat-factory-as-an-example.png)

Hình dưới là vùng bộ nhớ Java, hãy để tôi nói về mối quan hệ giữa thread và process từ góc độ JVM!

![Vùng dữ liệu runtime Java (sau JDK1.8)](/images/github/javaguide/java/jvm/java-runtime-data-areas-jdk1.8.png)
...
![Sơ đồ chuyển đổi trạng thái process](/images/github/javaguide/cs-basics/operating-system/state-transition-of-process.png)
...
![Các thuật toán lập lịch process thường gặp](/images/github/javaguide/cs-basics/network/scheduling-algorithms-of-process.png)
...
<img src="/images/github/javaguide/cs-basics/operating-system/deadlock-two-threads-waiting-for-each-other-to-release-lock.png" style="zoom: 50%;" />
...
![Sơ đồ minh họa deadlock thread](/images/github/javaguide/java/2019-4%E6%AD%BB%E9%94%811-20230814005444749.png)
...
![Đồ thị phân bổ tài nguyên process](/images/github/javaguide/cs-basics/operating-system/process-resource-allocation-diagram.jpg)
