...
![Directed Graph](/images/github/javaguide/cs-basics/data-structure/directed-graph.png)
...
![Weighted Directed Graph](/images/github/javaguide/cs-basics/data-structure/weighted-directed-graph.png)
...
![Adjacency Matrix của Undirected Graph](/images/github/javaguide/cs-basics/data-structure/adjacency-matrix-representation-of-undirected-graph.png)
...
![Adjacency Matrix của Directed Graph](/images/github/javaguide/cs-basics/data-structure/adjacency-matrix-representation-of-directed-graph.png)
...
![Adjacency List của Undirected Graph](/images/github/javaguide/cs-basics/data-structure/adjacency-list-representation-of-undirected-graph.png)

![Adjacency List của Directed Graph](/images/github/javaguide/cs-basics/data-structure/adjacency-list-representation-of-directed-graph.png)
...
![Minh họa BFS](/images/github/javaguide/cs-basics/data-structure/breadth-first-search.png)

**Cách triển khai cụ thể của BFS dùng cấu trúc dữ liệu tuyến tính đã học — Queue**. Quá trình cụ thể như hình dưới:

**Bước 1:**

![BFS bước 1](/images/github/javaguide/cs-basics/data-structure/breadth-first-search1.png)

**Bước 2:**

![BFS bước 2](/images/github/javaguide/cs-basics/data-structure/breadth-first-search2.png)

**Bước 3:**

![BFS bước 3](/images/github/javaguide/cs-basics/data-structure/breadth-first-search3.png)

**Bước 4:**

![BFS bước 4](/images/github/javaguide/cs-basics/data-structure/breadth-first-search4.png)

**Bước 5:**

![BFS bước 5](/images/github/javaguide/cs-basics/data-structure/breadth-first-search5.png)

**Bước 6:**

![BFS bước 6](/images/github/javaguide/cs-basics/data-structure/breadth-first-search6.png)
...
![Minh họa DFS](/images/github/javaguide/cs-basics/data-structure/depth-first-search.png)

**Tương tự BFS, cách triển khai cụ thể của DFS dùng cấu trúc dữ liệu tuyến tính khác — Stack**. Quá trình cụ thể như hình dưới:

**Bước 1:**

![DFS bước 1](/images/github/javaguide/cs-basics/data-structure/depth-first-search1.png)

**Bước 2:**

![DFS bước 2](/images/github/javaguide/cs-basics/data-structure/depth-first-search2.png)

**Bước 3:**

![DFS bước 3](/images/github/javaguide/cs-basics/data-structure/depth-first-search3.png)

**Bước 4:**

![DFS bước 4](/images/github/javaguide/cs-basics/data-structure/depth-first-search4.png)

**Bước 5:**

![DFS bước 5](/images/github/javaguide/cs-basics/data-structure/depth-first-search5.png)

**Bước 6:**

![DFS bước 6](/images/github/javaguide/cs-basics/data-structure/depth-first-search6.png)
