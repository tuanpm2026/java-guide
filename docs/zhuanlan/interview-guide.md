...
![Hiệu ứng demo](/images/xingqiu/pratical-project/interview-guide/page-resume-history.png)
...
![Cách viết CV 《Nền tảng phỏng vấn thông minh SpringAI + Kho tri thức RAG》](/images/xingqiu/pratical-project/interview-guide/project-on-resume.png)
...
![Ý tưởng phát triển chi tiết kho tri thức RAG](/images/xingqiu/pratical-project/interview-guide/rag-knowledge-base-coding.png)
...
![Tổng quan nội dung hướng dẫn đi kèm](/images/xingqiu/pratical-project/interview-guide/tutorial-overview.png)
...
![Phiếu giảm giá Kiến thức sao 30 tệ](/images/xingqiu/xingqiuyouhuijuan-30.jpg)
...
![](/images/xingqiu/pratical-project/interview-guide/page-interview-hub.png)

Ra câu hỏi Skill + phân tích JD:

![](/images/xingqiu/pratical-project/interview-guide/page-skill-jd-parse.png)

Thư viện CV:

![](/images/xingqiu/pratical-project/interview-guide/page-resume-history.png)

Tải lên và phân tích CV:

![](/images/xingqiu/pratical-project/interview-guide/page-resume-upload-analysis.png)

Chi tiết phân tích CV:

![](/images/xingqiu/pratical-project/interview-guide/page-resume-analysis-detail.png)

Lịch sử phỏng vấn:

![](/images/xingqiu/pratical-project/interview-guide/page-interview-history.png)

Chi tiết phỏng vấn:

![](/images/xingqiu/pratical-project/interview-guide/page-interview-detail.png)

Phỏng vấn mô phỏng:

![](/images/xingqiu/pratical-project/interview-guide/page-mock-interview.png)

Sắp xếp phỏng vấn

![](/images/xingqiu/pratical-project/interview-guide/page-interview-schedule-list.png)

### Kho tri thức

Quản lý kho tri thức:

![](/images/xingqiu/pratical-project/interview-guide/page-knowledge-base-management.png)

Trợ lý hỏi đáp:

![page-qa-assistant](/images/xingqiu/pratical-project/interview-guide/page-qa-assistant.png)
