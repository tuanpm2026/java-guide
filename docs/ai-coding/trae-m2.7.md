...
![Trae添加模型入口](/images/github/javaguide/ai/coding/m2.7/trae-add-model-entry.png)

**Bước 3**: Chọn "Other Models" và nhập thủ công Model ID và API Key:

![选择Other Models](/images/github/javaguide/ai/coding/m2.7/select-other-models.png)
...
![输入模型ID和API Key](/images/github/javaguide/ai/coding/m2.7/input-minimax-m2.7-api-key.png)
...
![向M2.7下达的诊断指令截图](/images/github/javaguide/ai/coding/m2.7/m2.7-diagnostic-instruction.png)
...
![M2.7推理结果截图](/images/github/javaguide/ai/coding/m2.7/m2.7-inference-result.png)
...
![M2.7代码调用链路分析截图](/images/github/javaguide/ai/coding/m2.7/m2.7-call-chain-analysis.png)
...
![M2.7调用链路分析](/images/github/javaguide/ai/coding/m2.7/m2.7-call-chain-analysis-2.png)
...
![M2.7调用链路图截图](/images/github/javaguide/ai/coding/m2.7/m2.7-call-chain-diagram.png)
...
![M2.7方案三代码片段](/images/github/javaguide/ai/coding/m2.7/m2.7-solution-3-code.png)
...
![hotfix方案指令](/images/github/javaguide/ai/coding/m2.7/hotfix-instruction.png)

Sau khi mô hình nhận chỉ lệnh, chính xác hiểu vấn đề, hoàn thành phân chia task và từng bước thực thi:

![M2.7任务拆解过程](/images/github/javaguide/ai/coding/m2.7/m2.7-task-breakdown.png)
...
![M2.7全局分析指令](/images/github/javaguide/ai/coding/m2.7/m2.7-global-analysis-instruction.png)

Lúc này mô hình bắt đầu đọc và phân tích suy luận chi tiết dựa trên cấu trúc dự án toàn cục và ngữ cảnh:

![M2.7项目结构分析](/images/github/javaguide/ai/coding/m2.7/m2.7-project-structure-analysis.png)
...
![M2.7故障根因分析](/images/github/javaguide/ai/coding/m2.7/m2.7-root-cause-analysis.png)
...
![M2.7优化方案建议](/images/github/javaguide/ai/coding/m2.7/m2.7-optimization-suggestion.png)
...
![M2.7慢查询数据结构分析](/images/github/javaguide/ai/coding/m2.7/m2.7-slowlog-data-structure.png)
...
![M2.7慢查询切面逻辑](/images/github/javaguide/ai/coding/m2.7/m2.7-slowlog-aspect-logic.png)
...
![M2.7 slot get指令分析](/images/github/javaguide/ai/coding/m2.7/m2.7-slot-get-instruction.png)
...
![慢查询设计文档](/images/github/javaguide/ai/coding/m2.7/m2.7-slowlog-design-doc.png)
...
![M2.7可行性分析](/images/github/javaguide/ai/coding/m2.7/m2.7-feasibility-analysis.png)
...
![M2.7链表结构体分析](/images/github/javaguide/ai/coding/m2.7/m2.7-linked-list-structure.png)
...
![M2.7 Go风格结构体](/images/github/javaguide/ai/coding/m2.7/m2.7-go-style-struct.png)
...
![M2.7时间测量切面](/images/github/javaguide/ai/coding/m2.7/m2.7-time-measurement-aspect.png)
...
![M2.7慢查询指令实现](/images/github/javaguide/ai/coding/m2.7/m2.7-slowlog-command-implementation.png)
...
![M2.7配置加载实现](/images/github/javaguide/ai/coding/m2.7/m2.7-config-loading.png)
...
![slowlog get初始状态](/images/github/javaguide/ai/coding/m2.7/slowlog-get-initial-state.png)
...
![slowlog get记录set命令](/images/github/javaguide/ai/coding/m2.7/slowlog-get-record-set-command.png)
...
![slowlog get多条记录](/images/github/javaguide/ai/coding/m2.7/slowlog-get-multiple-records.png)
