...
![点击添加模型](/images/ai/coding/glm5.1-cc/add-model-entry.png)

Chọn mô hình tương ứng:

![选择模型](/images/ai/coding/glm5.1-cc/select-model.png)

Cấu hình tham số:

![配置参数](/images/ai/coding/glm5.1-cc/config-params.png)

Cấu hình JSON về quan hệ tương ứng giữa biến môi trường mô hình nội bộ Claude Code và mô hình đích:

![Claude Code 内部模型环境变量与模型对应关系 JSON 配置](/images/ai/coding/glm5.1-cc/model-env-json-config.png)
...
![VSCode + Claude Code for VS Code](/images/ai/coding/glm5.1-cc/vscode-claude-code.png)
...
![AI 自主完成技术方案规划](/images/ai/coding/glm5.1-cc/ai-tech-plan.png)
...
![AI 检索 Agent 技术选型和 Arthas 集成方案](/images/ai/coding/glm5.1-cc/agent-arthas-integration-research.png)
...
![AI 输出的系统架构设计图](/images/ai/coding/glm5.1-cc/system-architecture-design.png)
...
![AI 输出的核心角色分工表](/images/ai/coding/glm5.1-cc/core-component-roles.png)
...
![AI 输出的数据流设计](/images/ai/coding/glm5.1-cc/data-flow-design.png)
...
![AI 给出的后续扩展建议](/images/ai/coding/glm5.1-cc/extension-suggestions.png)
...
![AI 自主编码过程](/images/ai/coding/glm5.1-cc/ai-coding-process.png)
...
![AI 完成编码后输出的交付清单](/images/ai/coding/glm5.1-cc/delivery-checklist.png)
...
![AI 完成 Agent Chat UI 页面集成](/images/ai/coding/glm5.1-cc/agent-chat-ui-integration.png)
...
![Agent 诊断效果演示](/images/ai/coding/glm5.1-cc/agent-diagnosis-demo.png)
...
![接口耗时 18 秒的调测结果](/images/ai/coding/glm5.1-cc/search-api-18s-result.png)
...
![AI 给出的慢查询解决方案](/images/ai/coding/glm5.1-cc/slow-query-solution.png)

Đồng thời đưa ra gợi ý tối ưu hóa theo giai đoạn và hiệu quả kỳ vọng:

![AI 给出的分阶段优化建议](/images/ai/coding/glm5.1-cc/phased-optimization-suggestions.png)
...
![AI 输出的索引优化 SQL 脚本](/images/ai/coding/glm5.1-cc/index-optimization-sql.png)
...
![AI 在既有代码中完成增量优化](/images/ai/coding/glm5.1-cc/incremental-code-optimization.png)
...
![AI 针对深分页场景基于阈值自动切换查询策略的代码实现](/images/ai/coding/glm5.1-cc/deep-pagination-threshold-code.png)
...
![AI 输出的最终优化效果总结](/images/ai/coding/glm5.1-cc/optimization-summary.png)
...
![优化后接口耗时降至 300ms 以内](/images/ai/coding/glm5.1-cc/optimized-api-300ms.png)
