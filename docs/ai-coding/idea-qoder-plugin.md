...
![Giao diện cài đặt plugin](/images/github/javaguide/ai/coding/qoder/idea-plugin/plugin-install-interface.png)

**Bước 2**: Sau khi cài đặt xong, nhấp Sign In để đăng nhập/đăng ký.

![Giao diện đăng nhập](/images/github/javaguide/ai/coding/qoder/idea-plugin/login-interface.png)
...
![Giao diện cài đặt ngôn ngữ](/images/github/javaguide/ai/coding/qoder/idea-plugin/language-settings-interface.png)
...
![Thêm nguồn dữ liệu](/images/github/javaguide/ai/coding/qoder/idea-plugin/add-data-source.png)

Điền thông tin kết nối, sau khi test thành công nhấp OK.

![Cấu hình cơ sở dữ liệu hoàn tất](/images/github/javaguide/ai/coding/qoder/idea-plugin/database-config-complete.png)
...
![Thêm database context](/images/github/javaguide/ai/coding/qoder/idea-plugin/add-database-context-1.png)
...
![Kết quả phân tích code](/images/github/javaguide/ai/coding/qoder/idea-plugin/code-analysis-result.png)
...
![Báo cáo phân tích toàn diện](/images/github/javaguide/ai/coding/qoder/idea-plugin/comprehensive-analysis-report.png)

**Tối ưu tầng code**

Qoder đưa ra ba bộ phương án, bao gồm deferred join query (subquery chỉ trả về ID, sử dụng covering index để định vị nhanh):

![Phương án tối ưu code](/images/github/javaguide/ai/coding/qoder/idea-plugin/code-optimization-solution.png)
...
![Gợi ý tối ưu cơ sở dữ liệu](/images/github/javaguide/ai/coding/qoder/idea-plugin/database-optimization-suggestion.png)
...
![Code sau khi tái cấu trúc](/images/github/javaguide/ai/coding/qoder/idea-plugin/refactored-code.png)

Script index có thể thực thi trực tiếp trong IDE, toàn bộ workflow không cần chuyển cửa sổ:

![Thực thi index](/images/github/javaguide/ai/coding/qoder/idea-plugin/index-execution.png)

**Kiểm tra hồi quy**: Qoder hoàn thành sắp xếp các nhánh code, và tạo unit test cho các tình huống khác nhau:

![Unit test](/images/github/javaguide/ai/coding/qoder/idea-plugin/unit-test-1.png)
...
![Stress test](/images/github/javaguide/ai/coding/qoder/idea-plugin/stress-test.png)

Cuối cùng, Qoder xuất ra tóm tắt công việc đầy đủ, bao gồm phương án kỹ thuật và gợi ý báo cáo giao tiếp:

![Tóm tắt công việc](/images/github/javaguide/ai/coding/qoder/idea-plugin/work-summary.png)
...
![Mô tả commit](/images/github/javaguide/ai/coding/qoder/idea-plugin/commit-message.png)
...
![Thêm database context](/images/github/javaguide/ai/coding/qoder/idea-plugin/add-database-context-2.png)

Sau khi Qoder nhận nhiệm vụ, bắt đầu từ tổng quan, thực thi nhiệm vụ theo cách sắp xếp và bổ sung comment từng nhánh:

![Quá trình sắp xếp logic](/images/github/javaguide/ai/coding/qoder/idea-plugin/logic-analysis-process.png)
...
![Ví dụ code được comment](/images/github/javaguide/ai/coding/qoder/idea-plugin/commented-code-example.png)

Sau khi nhiệm vụ kết thúc, Qoder tóm tắt rõ ràng logic interface và các điểm quy tắc đặc biệt:

![Tóm tắt kết luận](/images/github/javaguide/ai/coding/qoder/idea-plugin/summary-conclusion.png)
...
![Nghiệm thu unit test](/images/github/javaguide/ai/coding/qoder/idea-plugin/unit-test-verification.png)
...
![Triển khai lặp tính năng](/images/github/javaguide/ai/coding/qoder/idea-plugin/feature-iteration-implementation.png)
...
![Tích lũy bộ nhớ](/images/github/javaguide/ai/coding/qoder/idea-plugin/memory-accumulation.png)
