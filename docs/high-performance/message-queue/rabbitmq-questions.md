...
![Sơ đồ kiến trúc cốt lõi RabbitMQ 4.0 và luồng vòng đời tin nhắn](/images/github/javaguide/high-performance/rabbitmq/rabbitmq-core-architecture-and-message-lifecycle-flow.png)
...
![So sánh bốn loại RabbitMQ Exchange](/images/github/javaguide/high-performance/rabbitmq/rabbitmq-exchange-types.png)
...
![Sơ đồ toàn cảnh độ tin cậy tin nhắn và kiến trúc queue RabbitMQ 4.0](/images/github/javaguide/high-performance/rabbitmq/rabbitmq-message-reliability-and-queue-architecture-overview.png)
